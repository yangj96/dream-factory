...
def main():
    ...
    parser.add_argument('--model_url', default='./cache/karras2019stylegan-ffhq-1024x1024.pkl', help='Fetch a StyleGAN model to train on') # karras2019stylegan-ffhq-1024x1024.pkl
